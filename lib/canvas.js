            ...
            if (global.canUpgrade) {
                switch (event.keyCode) {
                    case global.KEY_CHOOSE_1:
                        this.socket.talk('U', 0, parseInt(gui.upgrades[upgradeIndex][0]));
                        break;
                    case global.KEY_CHOOSE_2:
                        this.socket.talk('U', 1, parseInt(gui.upgrades[upgradeIndex][0]));
                        break;
                    case global.KEY_CHOOSE_3:
                        this.socket.talk('U', 2, parseInt(gui.upgrades[upgradeIndex][0]));
                        break;
                    case global.KEY_CHOOSE_4:
                        this.socket.talk('U', 3, parseInt(gui.upgrades[upgradeIndex][0]));
                        break;
                    case global.KEY_CHOOSE_5:
                        this.socket.talk('U', 4, parseInt(gui.upgrades[upgradeIndex][0]));
                        break;
                    case global.KEY_CHOOSE_6:
                        this.socket.talk('U', 5, parseInt(gui.upgrades[upgradeIndex][0]));
                        break;
                }
            }
        }
