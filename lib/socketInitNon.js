                                   ...
                                   .catch(error => {
                                    if (m[2] == true) {
                                      ...
                                      global.messages.push({
                                        text: "Failed to connect to the server, You have been sended back to nexus.",
                                        status: 2,
                                        alpha: 0,
                                        time: Date.now(),
                                      });
                                      ...
                                      global.disconnected = true;
                                      global.message = "Could not connect to the server."
                                      global.reasonmessage = "The connection has closed."
                                    }
                                  })
                                 }, 100)
                           break;
